...
if ($_GET['sort'] && $_GET['type']) {
    ...
    $orderby = "order by  pos_state DESC , torrents.editdate DESC , torrents.id DESC";
    $pagerlink = "";
...
if (get_user_class() < $torrentmanage_class) $wherea[] = "owner =" . $CURUSER["id"];
        ...
        <table border="1" class="searchbox" cellspacing="0" cellpadding="5" width="100%">
            ...
            <tr>
                <td class="rowfollow" align="center" colspan="2">
                    ...
                    <?php
                    $sourcelid = (int)$_GET['cat'];
                    function printcatone($name, $listarray, $cbname)
                    {
                        global $catpadding, $catsperrow, $lang_torrents, $CURUSER, $CURLANGDIR, $catimgurl;
                        ...
                        foreach ($listarray as $list) {
                            ...
                            print("<td align=\"center\" class=\"bottom\" style=\"padding-bottom: 4px; padding-left: " . $catpadding . "px;\">" . "&nbsp<a title=\"" . $list[name] . "\" href=\"?" . $cbname . "=" . $list[id] . "\"><b>" . $list[name] . "</b></a>&nbsp</td>\n");
                            $i++;
                        }
                        print("</tr></table>");
                    }

                    if (searchbox_item_list("audiocodecs", $sourcelid) && $sourcelid) printcatone("", searchbox_item_list("audiocodecs", $sourcelid), "cat=" . $sourcelid . "&audiocodec"); ?>
                </td>
