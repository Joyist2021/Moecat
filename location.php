...
if ($edited == 1) {
    ...
    {
        if (ip2long6($end_ip) > ip2long6($start_ip)) {
            $query = "UPDATE locations SET name = " . sqlesc($name) . ",flagpic = " . sqlesc($flagpic) . ",location_main = " . sqlesc($location_main) . ",location_sub= " . sqlesc($location_sub) . ",start_ip = " . sqlesc($start_ip) . ",end_ip = " . sqlesc($end_ip) . ",start_ip6 = " . sqlesc(ip2long6($start_ip)) . ",end_ip6 = " . sqlesc(ip2long6($end_ip)) . ",theory_upspeed = " . sqlesc($theory_upspeed) . ",practical_upspeed = " . sqlesc($practical_upspeed) . ",theory_downspeed = " . sqlesc($theory_downspeed) . ",practical_downspeed = " . sqlesc($practical_downspeed) . ",ipv6 = " . sqlesc($ipv6) . " WHERE id=" . sqlesc($id);
...
if ($editid > 0) {
    ...
    echo("<tr><td class=rowhead>Name:</td><td class=rowfollow align=left><input type='text' size=50 name='name' value='$name'></td></tr>");
    ...
    echo("<tr><td class=rowhead><nobr>Start IP:</nobr></td><td class=rowfollow align=left><input type='text' size=50 name='start_ip' value='" . $start_ip . "'></td></tr>");
    echo("<tr><td class=rowhead><nobr>End IP:</nobr></td><td class=rowfollow align=left><input type='text' size=50 name='end_ip' value='" . $end_ip . "'></td></tr>");

    echo("<tr><td class=rowhead><nobr>IP TYPE:</nobr></td><td class=rowfollow align=left><input name='ipv6' value='0' type='radio' " . ($ipv6 == 0 ? "checked='checked'" : "") . " />IPV6<input name='ipv6' value='1' type='radio' " . ($ipv6 == 1 ? "checked='checked'" : "") . " />IPV4</td></tr>");


    echo("<tr><td class=rowhead><nobr>Theory Up:</nobr></td><td class=rowfollow align=left><input type='text' size=50 name='theory_upspeed' value='$theory_upspeed'></td></tr>");
    echo("<tr><td class=rowhead><nobr>Theory Down:</nobr></td><td class=rowfollow align=left><input type='text' size=50 name='theory_downspeed' value='$theory_downspeed'></td></tr>");
    echo("<tr><td class=rowhead><nobr>Practical Up:</nobr></td><td class=rowfollow align=left><input type='text' size=50 name='practical_upspeed' value='$practical_upspeed'></td></tr>");
    echo("<tr><td class=rowhead><nobr>Practical Down:</nobr></td><td class=rowfollow align=left><input type='text' size=50 name='practical_downspeed' value='$practical_downspeed'></td></tr>");
...
if ($add == 'true') {
    ...
    {
        if (ip2long6($end_ip) > ip2long6($start_ip)) {
            $query = "INSERT INTO locations (name, flagpic, location_main, location_sub, start_ip, end_ip, theory_upspeed, practical_upspeed, theory_downspeed, practical_downspeed,ipv6 , start_ip6, end_ip6 ) VALUES (" . sqlesc($name) . "," . sqlesc($flagpic) . "," . sqlesc($location_main) . "," . sqlesc($location_sub) . "," . sqlesc($start_ip) . "," . sqlesc($end_ip) . "," . sqlesc($theory_upspeed) . "," . sqlesc($practical_upspeed) . "," . sqlesc($theory_downspeed) . "," . sqlesc($practical_downspeed) . "," . sqlesc($ipv6) . "," . sqlesc(ip2long6($start_ip)) . "," . sqlesc(ip2long6($end_ip)) . ")";
            $sql = sql_query($query) or sqlerr(__FILE__, __LINE__);
            if ($sql) {
                $success = true;
            } else {
...
echo("<tr><td class=rowhead>Name:</td><td class=rowfollow align=left><input type='text' size=50 name='name'></td></tr>");
...
echo("<tr><td class=rowhead><nobr>Start IP:</nobr></td><td class=rowfollow align=left><input type='text' size=50 name='start_ip'></td></tr>");
echo("<tr><td class=rowhead><nobr>End IP:</nobr></td><td class=rowfollow align=left><input type='text' size=50 name='end_ip'></td></tr>");
echo("<tr><td class=rowhead><nobr>IP TYPE:</nobr></td><td class=rowfollow align=left><input name='ipv6' value='0' type='radio' checked='checked' />IPV6<input name='ipv6' value='1' type='radio' />IPV4</td></tr>");
echo("<tr><td class=rowhead><nobr>Theory Up:</nobr></td><td class=rowfollow align=left><input type='text' size=50 name='theory_upspeed'></td></tr>");
echo("<tr><td class=rowhead><nobr>Theory Down:</nobr></td><td class=rowfollow align=left><input type='text' size=50 name='theory_downspeed'></td></tr>");
echo("<tr><td class=rowhead><nobr>Practical Up:</nobr></td><td class=rowfollow align=left><input type='text' size=50 name='practical_upspeed'></td></tr>");
echo("<tr><td class=rowhead><nobr>Practical Down:</nobr></td><td class=rowfollow align=left><input type='text' size=50 name='practical_downspeed'></td></tr>");
...
echo("<tr><td class=rowhead><nobr>Start IP:</nobr></td><td class=rowfollow align=left><input type='text' size=50 name='range_start_ip' value='" . $range_start_ip . "'></td></tr>");
echo("<tr><td class=rowhead><nobr>End IP:</nobr></td><td class=rowfollow align=left><input type='text' size=50 name='range_end_ip' value='" . $range_end_ip . "'><input type='hidden' name='check_range' value='true'></td></tr>");
echo("<tr><td class=toolbox align=center colspan=2><input class=btn type='Submit'></td></tr>");
echo("</table>");
echo("</form>");
...
if ($check_range == 'true') {
    ...
    if (validip_format($range_start_ip) && validip_format($range_end_ip)) {
        if (ip2long6($range_end_ip) > ip2long6($range_start_ip)) {
            $wherea = "WHERE INET_ATON(start_ip) <=" . ip2long6($range_start_ip) . " AND INET_ATON(end_ip) >=" . ip2long6($range_end_ip);
...
while ($row = mysql_fetch_array($sql)) {
    ...
    echo("<tr><td class=rowfollow align=center><strong>$id</strong></td>" .
        "<td class=rowfollow align=left>$name</td>" .
        ...
        "<td class=rowfollow align=left>" . $ipv6 . "</td>" .
