...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $body = <<<EOD
{$lang_recover['mail_one']}{$lang_recover['mail_two']}{$lang_recover['mail_three']}
<br />
...
EOD;
    ...
    $res = sql_query("SELECT id, username, email, passhash, editsecret FROM users WHERE id = " . sqlesc($id)) or sqlerr(__FILE__, __LINE__);
    ...
    $body = <<<EOD
{$lang_recover['mail_two_zero']}{$arr["id"]}
