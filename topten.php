...
*/
    ...
    } elseif ($type == 8)    // search
    {
        ...
        <style type="text/css">
            ...
            #list_view tr.info td {
                padding: 0 10px
            }

            #list_view tr.info .quote {
                margin: 5px 0
            }
            ...
            #list_view .highlight, #list_view .expanded {
                background: #eefcee
            }

            #list_view .expanded td {
                border: 0
            }
...
//		$Cache->cache_value('douban_top250', $moderators=file_get_contents_function('http://movie.douban.com/top250?format=text'),3600);
        ...
        <thead>
        <tr>
            <td class="colhead" width="20">排名
            </th>
            <td class="colhead" width="520">名称
            </th>
            <td class="colhead" width="39">评分
            </th>
            <td class="colhead">评价人数
            </th>
        </tr>
        </thead>
