...
?>
    ...
    <script type="text/javascript"
            src="common.php<?php $cssupdatedate = ($cssdate_tweak ? "?" . htmlspecialchars($cssdate_tweak) : "");
            echo $cssupdatedate ?>"></script>
...
*/
            ...
            ?>
            <tr>
                <td class="toolbox" align="center" colspan="2"><b><?php /*echo $lang_upload['text_read_rules']*/ ?></b>
                    <input id="qr" type="button"
                           onclick="javascript:{closealltags();this.form.submit();this.disabled=true;}"
                           value="<?php echo "&nbsp;&nbsp;" . $lang_upload['submit_upload'] . "&nbsp;&nbsp;" ?>"/></td>
            </tr>
        </table>
    </form>
