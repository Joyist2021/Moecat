...
<?php			//stderr($lang_signup['std_error'], $lang_signup['std_uninvited'], 0);
    ...
    if (!$inv) stderr($lang_signup['std_error'], $lang_signup['std_uninvited'], 0);
    ...
    if ($registration != "no") {
        ?>
        <tr>
            <form method="post" action="signup.php?type=normal">
                <td>正常注册</td>
    ...
    if ($invitesystem != "no") {
        ?>
        <tr>
            <form method="post" action="signup.php?type=invite">
                <td>邀请码注册</td>
        ...
        <table border="1" cellspacing="0" cellpadding="10">
            ...
            <tr>
                ...
                <td class=rowfollow align=left><input type="text" style="width: 200px" name="wantusername"
                                                      value="<? echo cookietureuserid(true); ?>"/><br/>
                    <font class=small><?php echo $lang_signup['text_allowed_characters'] ?></font></td>
            </tr>
            <tr>
                <td class=rowhead><?php echo $lang_signup['row_pick_a_password'] ?></td>
                <td class=rowfollow align=left><input type="password" style="width: 200px" name="wantpassword"/><br/>
            ...
            <tr>
                ...
                <td class=rowfollow align=left><input type="password" style="width: 200px" name="passagain"/></td>
            </tr>

            <tr>
                <td class=rowhead><?php echo $lang_signup['row_email_address'] ?></td>
                <td class=rowfollow align=left><input type="text" style="width: 200px" name="email"
                                                      value='<? echo $inviteremail; ?>'/>
                    <table width=250 border=0 cellspacing=0 cellpadding=0>
                        <tr>
                            <td class=embedded><font
                                        class=small><?php echo($restrictemaildomain == 'yes' && ($type != 'invite' && $type != 'dean') ? $lang_signup['text_email_note'] . allowedemails() : "") ?>
                            </td>
                        </tr>
                        </font></td></tr></table>
                </td>
            ...
            */
            ...
            <tr>
                ...
                <td class=rowfollow align=left>
                    <input type=radio name=gender value=Male><?php echo $lang_signup['radio_male'] ?><input type=radio
                                                                                                            name=gender
                                                                                                            value=Female><?php echo $lang_signup['radio_female'] ?>
                    <input type=radio name=gender value='N/A' checked><?php echo $lang_signup['radio_na'] ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class=rowfollow align=left>
                    <input type=checkbox name=rulesverify value=yes><?php echo $lang_signup['checkbox_read_rules'] ?>
                    <br/>
            ...
            <tr>
                <td class=toolbox colspan="2" align="center"><font color=red><b>
                            <?php //echo $lang_signup['text_all_fields_required'] ?></b></font><input type="button"
                                                                                                      onclick="javascript:{this.disabled=true;this.form.submit()}"
                                                                                                      value=<?php echo $lang_signup['submit_sign_up'] ?> style='height:
                                                                                                      25px'>
                </td>
            </tr>
        </table>
