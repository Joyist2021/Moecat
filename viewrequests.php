...
if (!in_array($action, $allowed_actions))
    ...
    switch ($action) {
        case "list":
        {
            ...
            if ($_POST['query']) $limit = $limit . " and (request like " . sqlesc("%" . $_POST['query'] . "%") . " or descr like " . sqlesc("%" . $_POST['query'] . "%") . ")";
            ...
            //else
            {
                ...
                print("<br><b><a href='viewrequests.php?action=new'>添加</a> | <a href='viewrequests.php?finished=all'>查看所有</a> | <a href='viewrequests.php?finished=yes'>查看已解决</a> | <a href='viewrequests.php?finished=no'>查看未解决</a> | <a href='viewrequests.php?finished=ing'>查看解决中</a> | <a href='viewrequests.php?finished=my' " . get_requestcount() . ">查看我发布的</a></b><p>\n");
                ...
                if (mysql_num_rows($rows) == 0) {
                    ...
                    print("<tr><td class=colhead align=left>名称</td><td class=colhead align=center>最新出价</td><td class=colhead align=center>原始出价</td><td class=colhead  align=center>评论数</td><td class=colhead  align=center>应求数</td><td class=colhead align=center>求种者</td><td class=colhead align=center>时间</td><td class=colhead align=center>状态</td></tr>\n");
