...
?>
    <script type="text/javascript">
        ...
        $(function () {
            $('#shbox_text').keypress(function (e) {
                if (e.ctrlKey && e.which == 13 || e.which == 10) {
                    $('form[name=shbox]').submit();
                }
            });
        });
    </script>
        ...
        if ($showmovies[$type_each] == 'yes' && (!isset($CURUSER) || $CURUSER['show' . $type_each] == 'yes')) {
            ...
            if (!$Cache->get_page()) {
                ...
                if (mysql_num_rows($res) > 10) {
                    ...
                    ?>
                    <h2 class="index"><span
                                class="index"><?php echo $lang_index['text_' . $type_each . 'movies'] ?></span></h2>
                    <table width="100%" class="index" border="1" cellspacing="0" cellpadding="5">
                        <tr>
...
if ($showshoutbox_main == "yes") {
    ?>
    <h2 class="index"><span class="index"><?php echo $lang_index['text_shoutbox'] ?><font class="small"><span
                        id="shoutboxfont"> - [<a class="altlink shoutboxheight"
                                                 href='javascript:shoutboxheight();'>展开</a>] - [<a
                            class='altlink shoutboxstopre'
                            href='javascript:shoutboxstopre();'>暂停</a>]</span> - <?php echo $lang_index['text_auto_refresh_after'] ?></font><font
                    class='striking' id="countdown"></font><font
                    class="small"><?php echo $lang_index['text_seconds'] ?></font></span></h2>
    <?php
...
if ($CURUSER['showhot'] != 'yes' && $CURUSER['showclassic'] != 'yes' && $CURUSER['showfb'] != "yes") {
...
if ($uptimeresult)
{
    ...
    <table class="index" width="100%" border="1" cellspacing="0" cellpadding="10">
        <tr>
