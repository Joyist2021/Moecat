...
//cache_check ('faq');
    ...
    begin_frameindex($lang_faq['text_welcome_to'] . $SITENAME . " - " . $SLOGAN);
    ...
    if (isset($faq_categ)) {
        ...
        */
        ...
        begin_frameindex("<span id=\"top\">" . $lang_faq['text_contents'] . "</span>");
        foreach ($faq_categ as $id => $temp) {
