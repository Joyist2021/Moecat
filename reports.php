    ...
    switch ($row['type']) {
        case "torrent":
        {
            ...
            if (mysql_num_rows($res) == 0)
                ...
                $reporting = "<a href=details.php?id=" . $arr['id'] . ">" . htmlspecialchars($arr['name']) . "</a>" . $lang_reports['text_by'] . get_username($arr['owner']);
            }
            break;
        }
        case "user":
        ...
        case "comment":
        {
            ...
            if (mysql_num_rows($res) == 0)
                ...
                if ($arr['torrent']) {
                    ...
                    $url = "viewrequests.php?id=" . $arr['request'] . "#cid" . $row['reportid'];
...
?>
    <tr>
        <td class="colhead" colspan="7" align="right"><input type="submit" name="setdealt"
                                                             value="<?php echo $lang_reports['submit_set_dealt'] ?>"/><input
