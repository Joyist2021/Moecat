...
?>
    <tr>
        ...
        <td class="rowfollow"><input type="text" name="username" size="30"/></td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="2" class="toolbox" align="center"><input type="submit" value="Okay" class="btn"/></td>
    </tr>
<?php end_table(); ?>
    </form>
<?php end_main_frame(); ?>
        ...
        <table width=100% border=1 cellspacing=0 cellpadding=5>
            <tr>
                <td class="rowfollow" width="100%">
                    Are you sure you want to give all confirmed users 25.0 extra bonus point?<br/><br/></td>
            </tr>
            <tr>
                <td class="toolbox" align="center"><input type="hidden" name="doit" value="yes"/>
