...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($queries)
        $link .= "?" . $queries . "&passkey=" . $CURUSER['passkey'];
    else
        $link .= "?passkey=" . $CURUSER['passkey'];
    $msg = $lang_getrss['std_use_following_url'] . "\n[pre][code]" . $link . $addinclbm . "[/code][/pre]\n\n" . $lang_getrss['std_utorrent_feed_url'] . "\n[pre][code]" . $link . "&linktype=dl" . $addinclbm . "[/code][/pre]";
...
?>
    ...
    <form method="post" action="getrss.php">
        <table cellspacing="1" cellpadding="5" width=98%>
            <tr>
            ...
            <tr>
                ...
                <td class="rowfollow" align="left">
                    <input type="radio" name="inclbookmarked" id="inclbookmarked0" value="0" checked="checked"/><label
                            for="inclbookmarked0"><?php echo $lang_getrss['text_all'] ?></label>&nbsp;
                    <input type="radio" name="inclbookmarked" id="inclbookmarked1" value="1"/><label
                            for="inclbookmarked1"><?php echo $lang_getrss['text_only_bookmarked'] ?></label>&nbsp;
                    <input type="radio" name="inclbookmarked" id="inclbookmarked2" value="2"/><label
                            for="inclbookmarked2"><?php echo $lang_getrss['text_only_bookmarked'] . "且未完成" ?></label>

                    <div><?php echo $lang_getrss['text_show_bookmarked_note'] ?></div>
                </td>
            </tr>
            <tr>
                ...
                <td class="rowfollow" align="left">
                    <input type="checkbox" name="itemcategory"
                           value="1"/><?php echo $lang_getrss['text_item_category'] ?>&nbsp;<input type="checkbox"
                                                                                                   name="itemtitle"
                                                                                                   checked="checked"
                                                                                                   disabled="disabled"/><?php echo $lang_getrss['text_item_title'] ?>
                    &nbsp;<input type="checkbox" name="itemsmalldescr"
                                 value="1"/><?php echo $lang_getrss['text_item_small_description'] ?>&nbsp;<input
                            type="checkbox" name="itemsize" value="1"/><?php echo $lang_getrss['text_item_size'] ?>
                    &nbsp;<input type="checkbox" name="itemuploader"
                                 value="1"/><?php echo $lang_getrss['text_item_uploader'] ?>
                </td>
            </tr>
            <tr>
                <td class="rowhead"><?php echo $lang_getrss['row_rows_per_page'] ?></td>
                <td class="rowfollow" align="left"><select name="showrows">
            ...
            <tr>
                <td class="rowhead"><?php echo $lang_getrss['row_keyword'] ?></td>
                <td class="rowfollow" align="left">
