                                    ...
                                    <tr>
                                        <td class="embedded">
                                            <input id="searchinput" name="search" type="text"
                                                   ...
                                                   onkeypress="return noenter(event.keyCode);" x-webkit-speech/>
                                            <script src="javascript/suggest.js" type="text/javascript"></script>
                                            <div id="suggcontainer"
                                                 style="text-align: left; width:300px;  display: none;">
                                                <div id="suggestions"
                                                     style="width:300px; border: 1px solid rgb(119, 119, 119); cursor: default; position: absolute; color: rgb(0,0,0); background-color: rgb(255, 255, 255);"></div>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td class="embedded">
                                ...
                                <select name="search_area">
                                    ...
                                    */
                                    ...
                                    <option value="4"<?php print($_GET["search_area"] == 4 ? " selected=\"selected\"" : ""); ?>>
                                        电影信息
                                    </option>
                                    <option value="5"<?php print($_GET["search_area"] == 5 ? " selected=\"selected\"" : ""); ?>>
                                        影片编号
                                    </option>
                                    <option value="6"<?php print($_GET["search_area"] == 6 ? " selected=\"selected\"" : ""); ?>>
                                        种子HASH
                                    </option>
                                    <option value="7"<?php print($_GET["search_area"] == 7 ? " selected=\"selected\"" : ""); ?>>
                                        活动种子
                                    </option>
