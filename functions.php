...
function at_user_message($text, $identify, $title, $type, $owner)
{
    global $Cache;
    if ($type == "offer") {
        $subject = '你在候选(' . $title . ')中被@';
    } elseif ($type == "request") {
        $subject = '你在求种(' . $title . ')中被@';
    } elseif ($type == "topic") {
        $subject = '你在帖子(' . $title . ')中被@';
    } else {
        $subject = '你可能在种子(' . $title . ')中被@';
    }
    $haveowner = false;
...
function get_user_class_name($class, $compact = false, $b_colored = false, $I18N = false, $namecolour = "")
{
    ...
    switch ($class) {
        ...
        case UC_Warehouse:
        {
            $class_name = $this_lang_functions['text_Warehouse'];
            break;
        }////
    ...
    switch ($class) {
        ...
        case UC_Warehouse:
        {
            $class_name_color = $en_lang_functions['text_Warehouse'];
            break;
        }
        case UC_VIP:
        {
...
//str = str.replace(/<([\/]?)i[^>]*>/ig,"[$1i]");
        ...
        function tagspreview(obj) {
            if (!is_ie || is_ie >= 7) {
                var poststr = encodeURIComponent(document
            .<?php echo $form?>.<?php echo $text?>.
                value
            )
                ;
            ...
            <td align="left" colspan="2">
                <table cellspacing="1" cellpadding="2" border="0">
                    <tr style='margin:0px;padding:0px'>
                        <td class="embedded"><input style="font-weight: bold;font-size:11px; margin-right:0px"
                        ...
                        <td class="embedded"><input class="codebuttons" style="font-size:11px;margin-right:0px"
                                                    type="button" style="font-size:11px;margin-right:3px" name="list"
                                                    value="*" onclick="tag_list2()"/></td>
                        <td class="embedded"><input class="codebuttons" style="font-size:11px;margin-right:0px"
                                                    type="button" name="hr" value="---" onclick="javascript: tag_hr()"/>
                        </td>
                        <td class="embedded"><input class="codebuttons" style="font-size:11px;margin-right:0px"
                                                    type="button" name="quote" value="QUOTE"
                                                    onclick="javascript: simpletag('quote')"/></td>
                        <td class="embedded"><input class="codebuttons" style="font-size:11px;margin-right:3px"
                                                    type="button" name="code" value="CODE"
                                                    onclick="javascript: simpletag('code')"/></td>
                        ...
                        <td class="embedded"><input class="codebuttons" style="font-size:11px;margin-right:3px"
                                                    type="button" name="UUB" title="复制时请使用鼠标右键复制" value="粘贴"
                                                    onclick="javascript:winoppause()"/></td>
                        ...
                        ?>
                        <td class="embedded"><input style="font-size:11px;margin-right:3px" type="button"
                                                    onclick='javascript:closeall();' name='tagcount'
                                                    value="Close Tags"/></td>
                        <td class="embedded"><input style="font-size:11px;margin-right:3px" type="button"
                                                    onclick='javascript:tagspreview(this.parentNode);' value="预览"/></td>
                        <td class="embedded">
                            <select class="med codebuttons" style="margin-right:0px;width:50px;" name='align'
                                    onchange="alterfont(this.options[this.selectedIndex].value, 'align')">
                        ...
                        <td class="embedded"><select class="med codebuttons" style="margin-right:0px;" name='color'
                                ...
                                <option style="background-color:MediumSpringGreen" value="MediumSpringGreen">中春绿
                                </option>
                                ...
                                <option style="background-color:LightGoldenrodYellow" value="LightGoldenrodYellow">亮菊黄
                                </option>
                        ...
                        <td class="embedded">
                            <select class="med codebuttons" style="margin-right:0px;width:50px;" name='font'
                        ...
                        <td class="embedded">
                            <select class="med codebuttons" style="margin-right:0px;width:50px;" name='size'
        ...
        if ($enableattach_attachment == 'yes' && $CURUSER) {
            ...
            <tr>
                <td colspan="2" valign="middle">
                    <iframe src="attachment.php" width="100%" height="24" frameborder="0" scrolling="no"
