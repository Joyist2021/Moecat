...
switch ($ordernum) {
    case 1:
        $order = 'order by bonus desc';
        break;
    case 2:
        $order = 'order by bonus asc';;
        break;
    case 3:
        $order = 'order by winbonus desc';
        break;
    case 4:
        $order = 'order by winbonus asc';;
        break;
    case 5:
        $order = 'order by lossbonus desc';
        break;
    case 6:
        $order = 'order by lossbonus asc';;
        break;
    case 7:
        $order = 'order by winnum desc';
        break;
    case 8:
        $order = 'order by winnum asc';;
        break;
    case 9:
        $order = 'order by lossnum desc';
        break;
    case 10:
        $order = 'order by lossnum asc';;
        break;
    case 11:
        $order = 'order by per desc';
        break;
    case 12:
        $order = 'order by per asc';;
        break;
    case 13:
        $order = 'order by allbouns desc';
        break;
    case 14:
        $order = 'order by allbouns asc';;
        break;
    default:
        $order = 'order by allbouns desc';;
        break;
