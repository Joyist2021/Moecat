...
if ($action == 'showlist') {
    ...
    <form method=post action=allowedemails.php>
        ...
        <tr>
            <td>Enter a list of allowed email addresses (separated by spaces):<br/>To allow a specific address enter
                "email@domain.com", to allow an entire domain enter "@domain.com"
            </td>
