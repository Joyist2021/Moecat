...
<li><a href="?action=viewforum&amp;forumid=<?php echo $forumid . $addparam ?>&amp;sort=postcolour">主题颜色降序</a></li>
            ...
            <span id="order" onclick="dropmenu(this);"><span
                        style="cursor: pointer;"><b>点击选择<?php echo $lang_forums['text_order'] ?></b></span><br/>
        ...
        <div style="margin-left: 53px; margin-top: 13px;">
            <form method="get" action="forums.php" id="search_form"
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="512" class="search_table">
                    <tbody>
                    <tr>
                        <td style="padding-bottom: 3px; border: 0;"
                            valign="top"><?php echo $lang_forums['text_by_keyword'] ?></td>
                    </tr>
                    <tr>
                        <td style="padding-bottom: 3px; border: 0;" valign="top">
                            <input name="keywords" type="text" value="<?php echo $keywords ?>" style="width: 400px;"/>
                        </td>
                        <td style="padding-bottom: 3px; border: 0;" valign="top"><input name="image" type="image"
