...
$query = sql_query("SELECT id FROM users WHERE downloaded<1073741824 and uploaded>1073741824 and class IN (" . implode(",", $updateset) . ")");

$amount = sqlesc(getsize_int($amount, "G"));
sql_query("UPDATE users SET uploaded=uploaded + $amount WHERE downloaded<1073741824 and uploaded>1073741824 and class IN (" . implode(",", $updateset) . ")") or sqlerr(__FILE__, __LINE__);
