...
(
    'en' => array
    (
        'msg_your_offer_denied' => "Your Offer has been  denied",
        'msg_has_denied' => "has denied you to upload ",
    ...
    'chs' => array
    (
        'msg_your_offer_denied' => "你的候选被禁止",
        'msg_has_denied' => "禁止你上传 ",
    ...
    'cht' => array
    (
        'msg_your_offer_denied' => "你的候選被禁止",
        'msg_has_denied' => "禁止你上傳 ",
