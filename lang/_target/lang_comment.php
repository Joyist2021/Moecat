...
(
    'en' => array(
        ...
        'msg_new_comment2' => "New comment on your comment",
        'msg_torrent_receive_comment' => "You have received a comment on your torrent ",
        'msg_torrent_receive_comment2' => "You have received a comment on your comment ",
        ...
        'msg_offer_receive_comment2' => "You have received a comment on a offer ",
        'msg_request_receive_comment2' => "You have received a comment on a request "
    ),
    'chs' => array(
        'msg_new_comment' => "新评论",
        'msg_new_comment2' => "评论收到回复",
        'msg_torrent_receive_comment' => "你发布的种子收到了新评论 ",
        'msg_offer_receive_comment' => "你发布的候选收到了新评论 ",
        'msg_request_receive_comment' => "你发布的求种收到了新评论 ",
        'msg_request_receive_comment2' => "你对求种的评论收到了新回复 ",
        'msg_torrent_receive_comment2' => "你对种子的评论收到了新回复 ",
        'msg_offer_receive_comment2' => "你对候选的评论收到了新回复 "
    ),
    'cht' => array(
        'msg_new_comment' => "新評論",
        'msg_new_comment2' => "評論收到回覆",
        'msg_torrent_receive_comment' => "你發布的種子收到了新評論 ",
        'msg_offer_receive_comment' => "你發布的候選收到了新評論 ",
        'msg_request_receive_comment' => "你發布的求種收到了新評論 ",
        'msg_offer_receive_comment2' => "你对候選的評論收到了新回覆 ",
        'msg_torrent_receive_comment2' => "你對種子的評論收到了新回覆 "
