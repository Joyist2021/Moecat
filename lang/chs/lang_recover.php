...
(
    ...
    'mail_title' => " 网站密码重置验证",
    'mail_one' => "如题,<br /><br />你请求使用当前邮箱轮回你在" . $SITENAME . "网站魔法少女身份。<br />",
    'mail_two' => "<br />",
    'mail_three' => "请使用以下链接进行时空轮回: ",
    'mail_four' => "<br />轮回后，你的密码将被重置并通过另一封邮件发送给你。<br /><br />------<br />" . $SITENAME . " 网站",

    'mail_two_title' => " 网站账户信息",
    'mail_two_zero' => "如题，<br /><br />依你的愿望，我们给你的魔法少女身份进行轮回。<br /><br />以下是你的身份轮回后的参数：<br /><br />角色ID号：",
    'mail_two_one' => "<br />角色名称：",
    'mail_two_two' => "<br />角色密码：",
    'mail_two_three' => "<br /><br />",
    'mail_two_four' => "<br /><br />你可以在控制面板-安全设定中修改密码。<br />------<br />" . $SITENAME . " 网站",
