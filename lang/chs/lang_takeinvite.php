...
(
    ...
    'mail_here' => "这里",
    'mail_tilte' => "网站邀请函",
    'mail_one' => "如题，<br /><br />用户",
    'mail_two' => "希望你和TA结缔契约。成为" . $SITENAME . "的用户。 <br />如果你有意成为魔法少女，请在阅读网站规则后使用该契约。<br /><br />契约号为：",
    'mail_three' => "请在",
    'mail_four' => "内确认该契约，之后契约将作废。<br />" . $SITENAME . "真诚欢迎你加入我们的社区！<br /><br />来自邀请者",
    'mail_five' => "的话：",
    'mail_six' => "<br /><br />------<br />" . $SITENAME . "网站",
    'std_error' => "错误",
