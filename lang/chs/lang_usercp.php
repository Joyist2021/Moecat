...
(
    ...
    'text_seconds' => "秒刷新群聊区(0=使用默认设置, 最小=60, 最大=3600)",
    ...
    'text_at_special_page' => "回收站",
    'text_additional_selection' => "补充设定",
    'text_stylesheet_note' => "了解CSS并且想修改界面风格？",
    'text_stylesheet_link' => "点击这里进入",
    'row_font_size' => "字体大小",
    'select_small' => "小",
    'select_large' => "大",
    'text_medium' => "运行平台",
    ...
    'text_no_mark' => "无标记",
    'text_signature_note' => "允许使用<a class=faqlink href=tags.php target=_new>BBCode代码</a>。最大图片尺寸为500*200，只有前两张图片会显示。",
    ...
    'select_medium' => "中",
    'row_tooltip_last_post' => "悬浮提示最新回复",
