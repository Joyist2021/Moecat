...
(
    ...
    'text_torrent' => "个",
    'text_donors_always_get' => "为网站捐款者每次将得到",
...
<ul>",
    ...
    'text_updown' => "<h1>你的上传量或下载量将对魔力值值产生如下影响</h1>
<ul>
<li>每下载1GB，减少20点魔力值(按实际下载量计算)</li>
<li>每上传1GB，增加20点魔力值(按虚拟上传量计算)</li>
</ul>",
    ...
    'text_uploaded_one' => "青铜召唤",
    'text_uploaded_note' => "如果有足够的魔力值，你可以用它来换取上传量。交易完成后，你的魔力值会减少，上传量则会增加。",
    'text_uploaded_two' => "白银召唤",
    'text_uploaded_three' => "黄金召唤",
    'text_buy_invite' => "缔结契约",
    'text_buy_invite_note' => "如果有足够的魔力值，你可以用它来换取有效期为<b>" . $invite_timeout . "天</b>的邀请码。交易完成后，你的魔力值会减少，邀请码数则会增加。",
    'text_custom_title' => "头衔碎片",
    'text_custom_title_note' => "如果有足够的魔力值(第一次半价)，你就可以给自己定一个头衔了。注意：禁止使用脏话、攻击性的词汇或用户等级作为头衔。交易完成后，你的魔力值会减少，你的头衔将变成自定义的。",
    'text_vip_status' => "钻石金卡",
    'text_vip_status_note' => "如果有足够的魔力值(第一次半价)，你可以用它来换取一个月的贵宾待遇。交易完成后，你的魔力值会减少，同时你的等级将变为贵宾。",
    'text_bonus_gift' => "天神之光",
...
式中<ul><li><b>A</b>为中间变量</li><li><b>Ti</b>为第<b>i</b>个种子的生存时间, 即自种子发布起到现在所经过的时间, 单位是周</li><li><b>T0</b>为参数。<b>T0</b> = ",
    ...
    'text_no_advertisements' => "天享受和谐的日子",
