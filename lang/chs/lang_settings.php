...
(
    ...
    'row_max_ips' => "最多允许IP数",
    'text_max_ips_note' => "相同IP地址最大允许的未验证用户数。",
    ...
    'row_torrent_sticky' => "设定种子置顶,推荐种子",
    'text_torrent_sticky_note' => "。将种子设为置顶,推荐种子",
    ...
    'row_allow_userbar' => "允许奖励",
    'text_allow_userbar_note' => "。允许奖励1000魔力。",
    ...
    'text_one_gb_credit_note' => "个魔力值，如果他选择交换10.0 GB上传量。默认'1500'。",
    'row_five_gb_credit' => "5.0 GB上传量",
    'text_five_gb_credit_note' => "个魔力值，如果他选择交换50.0 GB上传量。默认'6000'。",
    'row_ten_gb_credit' => "10.0 GB上传量",
    'text_ten_gb_credit_note' => "个魔力值，如果他选择交换100.0 GB上传量。默认'10000'。",
    ...
    'text_downloaded_more_than' => "周，上传量大于",
    ...
    'text_weekend_free_uploading_note' => "默认'否'。设为'是'则允许所有用户在周末自由发布种子（从周六到周日23:59）。",
    ...
    'row_max_users' => "最大用户数",
    'text_max_users' => "当这个限制达到时，自由注册将关闭。",
    ...
    'text_allow' => "允许",
    'text_see_sql_list' => "等级的用户查看调试信息（在页面底部查看SQL语句列表，PHP报告信息）。默认",
