...
(
    ...
    'text_resend_confirmation_mail_note' => "<h1>重发确认邮件</h1>",
    'text_resend_confirmation_mail_note_bak' => "<h1>重发确认邮件</h1><p>填写以下表格使系统重发验证邮件。</p><p>只有注册且没有通过验证才能使用该功能，<br />若较长时间没通过验证,则你的账号信息已被删除，需要重新注册。</p><p><b>注意：</b>连续" . $maxloginattempts . "次尝试失败将导致你的IP地址被禁用！</p>",
    ...
    'mail_here' => "这里",
    'mail_one' => "如题 ",
    'mail_two' => ",<br /><br />你请求重新收取" . $SITENAME . "网站的契约确认邮件，并指定此邮箱地址 ",
    'mail_three' => " 为你的灵魂宝石。<br /><br />",
    'mail_four' => "请使用以下传送门来确认契约： ",
