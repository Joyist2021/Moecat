...
(
    ...
    'std_category_unselected' => "你必须选择正确的类型和次分类！",
    'std_invalid_filename' => "无效的文件名！请将种子文件重命名",
    'std_filename_not_torrent' => "无效的文件名(不是.torrent文件).",
    'std_empty_file' => "空文件！请尝试再次上传",
    'std_not_bencoded_file' => "你在搞什么鬼？你上传的不是Bencode文件！",
    'std_not_a_dictionary' => "不是目录",
    'std_dictionary_is_missing_key' => "种子文件内部关键参数缺失",
    ...
    'std_torrent_hash_error' => " 服务器非要说你的种子已存在(这个是BUG),还请重新制作种子吧",
);
