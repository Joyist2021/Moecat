...
<?*/
    if ($trueuserid) {
        ?>
        <tr>
            <td class="colhead" align="center" COLSPAN="2">该游客用户名</td>
        </tr>
        <?
    ...
    if ($showuser) {
        ?>
        <tr>
            <td class="colhead" align="center" COLSPAN="2">⑨位最近访问该IP段的用户与时间</td>
        </tr>
        <?
    ...
    if (isset($_GET["guestid"])) {
        ?>
        <td class="colhead" align="center" COLSPAN="2"><a href='<? echo $_SERVER['PHP_SELF'] ?>'>点击查看自己IP段信息</a>
        </td></tr><?
    } else {
        ?>
        <tr>
            <td class="colhead" align="center" COLSPAN="2">下方可输入IP进行查询</td>
        </tr>
        <tr>
            <td class="text" align="center" COLSPAN="2">
