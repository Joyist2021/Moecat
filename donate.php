            ...
            <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
                ...
                <p align="center">
                    ...
                    <input type="hidden" name="return"
                           value="<?php echo get_protocol_prefix() . $BASEURL; ?>/donate.php?do=thanks">
                    <input type="hidden" name="cancel_return"
                           value="<?php echo get_protocol_prefix() . $BASEURL; ?>/donate.php">
                    <br/>
                </p>
                <p align="center">
    ...
    if ($showalipay) {
        ...
        <td class=text align=left valign=top <?php echo $tdattr ?>>
            ...
            <form action="https://www.alipay.com/trade/fast_pay.htm" method="get">
                ...
                <br/><br/><br/><br/><br/>
                <p align="center">
                    <input type="image" src="pic/alipaybutton.gif" border="0" name="I2"
                           alt="Make payments with Alipay"/>
                    <br/><br/></p>
            </form>
        </td>
        <?php
