...
<table width="100%">
    <tr>
        <td class="text" align="center">
            <form method="post" action="addcss.php">
                ...
                <input type="submit" name="ok" value="修改"/><input type="submit" name="test" value="测试20秒"><input
                        type="submit" name="delete" value="删除"><br/>
    ...
    <tr>
        <td class="text" align="left">
            ...
            7:没有了,接下来就看各位的技术了,优秀的作品站长会挑选出来制作成网站主题,<a
                    href="http://www.w3cschool.cn/index-7.html"><b>CSS参考手册</b></a>.<br/>
            <br/></td>
    </tr>
    <tr>
        <td class="text" align="left">
    ...
    <tr>
        <td class="text" align="left">自定义CSS的用户: <? print join(" , ", $useridcssall); ?></td>
    </tr>
</table>
<?php
end_main_frame();
