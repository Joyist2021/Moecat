...
<form method=get action=<?php echo $_SERVER["PHP_SELF"] ?>>
    <table border="1" cellspacing="0" cellpadding="5">
        <tr>
            ...
            <td<?php echo $_GET['n'] ? $highlight : "" ?>><input name="n" type="text" value="<?php echo $_GET['n'] ?>"
                                                                 size=35></td>
        ...
        <tr>
            ...
            <td<?php echo $_GET['em'] ? $highlight : "" ?>><input name="em" type="text"
                                                                  value="<?php echo $_GET['em'] ?>" size="35"></td>
            <td valign="middle" class=rowhead>IP:</td>
            <td<?php echo $_GET['ip'] ? $highlight : "" ?>><input name="ip" type="text"
                                                                  value="<?php echo $_GET['ip'] ?>" maxlength="37"></td>
        ...
        <tr>
            ...
            <td<?php echo $_GET['co'] ? $highlight : "" ?>><input name="co" type="text"
                                                                  value="<?php echo $_GET['co'] ?>" size="35"></td>
            <td valign="middle" class=rowhead>Mask:</td>
            <td<?php echo $_GET['ma'] ? $highlight : "" ?>><input name="ma" type="text"
                                                                  value="<?php echo $_GET['ma'] ?>" maxlength="17"></td>
            <td valign="middle" class=rowhead>Class:</td>
            <td<?php echo ($_GET['c'] && $_GET['c'] != 1) ? $highlight : "" ?>><select name="c">
        ...
        <tr>
            ...
            <td<?php echo $_GET['ac'] ? $highlight : "" ?>><input name="ac" type="checkbox"
                                                                  value="1" <?php echo ($_GET['ac']) ? "checked" : "" ?>>
            </td>
            <td valign="middle" class=rowhead>Disabled IP:</td>
            <td<?php echo $_GET['dip'] ? $highlight : "" ?>><input name="dip" type="checkbox"
                                                                   value="1" <?php echo ($_GET['dip']) ? "checked" : "" ?>>
            </td>
        </tr>
        <tr>
...
if (count($_GET) > 0 && !$_GET['h']) {
    ...
    if ($ip) {
        ...
        if ($mask == "" || $mask == "255.255.255.255")
            $where_is .= (isset($where_is) ? " AND " : "") . "u.ip like '%$ip%'";
        else {
            if (substr($mask, 0, 1) == "/") {
