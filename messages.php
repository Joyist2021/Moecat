...
// Get Sender Username
                ...
                <tr class="colhead">
                    <td colspan="5" align="right" class="colhead"><input class=btn type="button"
                        ...
                        <input class=btn type="button" value="反选" onClick="checktocheck(form)">
     ...
     */ ?>
        ...
        <tr>
            <td class=toolbox colspan=5>
                <div align="center"><img class="bookmark" src="pic/trans.gif" alt="Unread"
                    ...
                    <img class="delbookmark" src="pic/trans.gif" alt="Read"
...
function insertJumpTo($selected = 0)
{
    ...
    <form action="messages.php" method="get">
        ...
        &nbsp;&nbsp;<input id="searchinput" name="keyword" type="text" value="<?php echo $_GET['keyword'] ?>"
                           style="width: 200px"/>
