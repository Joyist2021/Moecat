                    ...
                    <form method=post action=takestaffmess.php>
                        ...
                        <table cellspacing=0 cellpadding=5>
                            ...
                            if ($_GET["sent"] == 1) {
                                ?>
                                <tr>
                                    <td colspan=2><font color=red><b>The message has ben sent.</font></b>
                                </tr></td>
                                <?php
                            }
                            ?>
                            ...
                            <tr>
                                <td>Subject <input type=text name=subject size=75>
                            </tr>
                            </td>
                            <tr>
                            ...
                            <tr>
                                <td colspan=1 align=center><input type=submit value="Send!" class=btn></td>
                            </tr>
                        </table>
