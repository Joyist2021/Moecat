...
class imdb extends imdb_config
{
    ...
    function title()
    {
        if ($this->main_title == "") {
            ...
            for ($i = 1; $i < count($zh_CN[1]); $i++) {
                $this->main_title .= $zh_CN[1][$i] . "&nbsp;&nbsp;";
            }
...
#     $row_x = strpos( $temp, '<td valign="middle"' );
    ...
    function director()
    {
        if ($this->credits_director == "") {
            ...
            for ($i = 0; $i < count($zh_CN[1]); $i++) {
                $this->credits_director .= $zh_CN[1][$i] . "&nbsp;&nbsp;";
            }
    ...
    function writing()
    {
        if ($this->credits_writing == "") {
            ...
            preg_match_all("/\<name\>(.*?)\<\/name\>/sim", $this->page["Title"], $zh_CN);
            for ($i = 0; $i < count($zh_CN[1]); $i++) {
                $this->credits_writing .= $zh_CN[1][$i] . "&nbsp;&nbsp;";
            }
        }
    ...
    function producer()
    {
        if ($this->credits_producer == "") {
            ...
            for ($i = 0; $i < count($zh_CN[1]); $i++) {
                $this->credits_producer .= $zh_CN[1][$i] . "&nbsp;&nbsp;";
            }
